...
char currentLetter = 'm'; // Set initial letter to 'm'
int letterShift = 0; // Variable 
...
void mousePressed()
{
  if (didMouseClick(width/2-sizeOfInputArea/2, height/2-sizeOfInputArea/2+sizeOfInputArea/2, sizeOfInputArea/2, sizeOfInputArea/2)) {
    // Right button: Lower half middle
    if (currentLetter < 'm') {
      currentLetter = (char)('m' - (letterShift % 13));
    } else {
      currentLetter = (char)('m' + (letterShift % 13));
    }
    letterShift++;
  ...
  if (didMouseClick(width/2-sizeOfInputArea/2+sizeOfInputArea/2, height/2-sizeOfInputArea/2+sizeOfInputArea/2, sizeOfInputArea/2, sizeOfInputArea/2)) {
    // Left button: Upper half middle
    if (currentLetter < 'm') {
      currentLetter = (char)('m' + (letterShift % 13));
    } else {
      currentLetter = (char)('m' - (letterShift % 13));
  ...
  if (didMouseClick(width/2-sizeOfInputArea/2, height/2-sizeOfInputArea/2, sizeOfInputArea, sizeOfInputArea/2)) {
    // Center area: Space bar or back to 'm' if at limits
    if (currentLetter == '_') {
      currentLetter = ' ';
    } else {
      currentLetter = 'm';
      letterShift = 0; // Reset the letter shift when back to 'm'
    }
  }
